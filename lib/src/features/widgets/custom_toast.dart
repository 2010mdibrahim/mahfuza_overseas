...
//   Toast.show(msg, duration: Toast.lengthLong,backgroundColor: Colors.red,textStyle: TextStyle(color: ThemeConfig.white));
// }
...
showLoaderDialog(BuildContext context, String message) {
  AlertDialog alert = AlertDialog(
    content: Row(
      children: [
        CircularProgressIndicator(backgroundColor: ThemeConfig.logoColor),
